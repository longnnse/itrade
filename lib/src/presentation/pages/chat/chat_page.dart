...
class ChatPage extends GetView<ChatController> {
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  for (int i = 0; i < 10; i++) _buildItemChat(context: context)
                ],
              ),
            )),
            Container(
  ...
  Widget _buildItemChat({required BuildContext context}) {
    return Container(
      ...
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(10.0),
          border: Border.all(color: kBackground, width: 2.0)),
      child: Row(
        children: [
          Container(
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                      color: kTextColorGrey, fontWeight: FontWeight.w400),
                ),
                Text(
                  '10:24 08/05/2023',
                  style: Theme.of(context).textTheme.bodyMedium!.copyWith(
          ...
          ShaderMask(
            ...
            shaderCallback: (Rect bounds) =>
                kDefaultIconGradient.createShader(bounds),
            child:
                const Icon(Icons.call, color: kPrimaryLightColor, size: 30.0),
          )
        ],
      ),
    );
