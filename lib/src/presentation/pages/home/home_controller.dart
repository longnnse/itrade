...
class HomeController extends GetxController {
  ...
  Future<void> postSellFree(
      {required String postID, required String desc}) async {
    //TODO use test
    isLoadingRequest.call(true);
    final Either<ErrorObject, SellFreeResultModel> res =
        await _homeService.postSellFree(postID: postID, desc: desc);
    ...
    res.fold(
      ...
      (value) async {
        Get.snackbar('Thông báo', 'Gửi yêu cầu thành công',
  ...
  Future<void> getCategories(
    ...
    //TODO use test
    isLoading.call(true);
    final Either<ErrorObject, List<CategoryModel>> res = await _homeService
        .getCategories(pageSize: pageSize, pageIndex: pageIndex);
  ...
  Future<void> getPosts(
    ...
    final Either<ErrorObject, ProductModel> res = await _homeService.getPosts(
        pageSize: pageSize,
        pageIndex: pageIndex,
  ...
  Future<void> getPostByID({required String id}) async {
    ...
    final Either<ErrorObject, Data> res =
        await _homeService.getPostByID(id: id);
